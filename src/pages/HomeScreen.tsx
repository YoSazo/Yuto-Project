...
{/* Function Payment Modal */}
      ...
      <button
        ...
        className="fixed bottom-28 left-1/2 -translate-x-1/2 px-8 py-3.5 bg-black text-white rounded-full shadow-lg flex items-center gap-2 font-bold text-sm z-40 hover:bg-gray-800 transition-colors"
      >
