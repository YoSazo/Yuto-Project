              ...
              <div key={fn.id} className="flex flex-col p-4 rounded-3xl border border-gray-100 bg-white shadow-sm relative overflow-hidden">
                ...
                {ownListingOptionsOpen === fn.id && (
                  <>
                    ...
                    <div className="absolute top-12 right-3 z-30 w-44 bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden flex flex-col py-1">
                      {(fn as any).status !== "cancelled" && (
                        ...
                        }} className="px-4 py-2 text-sm font-bold text-left hover:bg-gray-50 border-none bg-transparent">
                          Cancel Event
                        </button>
                      )}
