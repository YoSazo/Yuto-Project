...
const WaIcon = ({ size = 16 }: { size?: number }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 175.216 175.552" width={size} height={size}>
    <path fill="#fff" d="M87.184 14.227c-39.2 0-71.1 31.9-71.112 71.1a70.9 70.9 0 0 0 10.86 37.8l-11.54 42.14 43.17-11.32a70.9 70.9 0 0 0 28.6 6.1h.03c39.2 0 71.1-31.9 71.11-71.1a70.7 70.7 0 0 0-20.8-50.3 70.7 70.7 0 0 0-50.3-20.84z"/>
    <defs>
