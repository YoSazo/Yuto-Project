      ...
      <div className="bg-white dark:bg-zinc-900 rounded-t-3xl md:rounded-3xl w-full max-w-md max-h-[min(92vh,720px)] flex flex-col modal-slide-up shadow-xl transition-colors">
        <div className="flex justify-between items-start gap-3 p-6 pb-2 shrink-0 border-b border-gray-100 dark:border-zinc-800">
          <div className="flex items-center gap-2 min-w-0">
            <div className="w-10 h-10 rounded-2xl bg-gray-100 dark:bg-zinc-800 text-black dark:text-white flex items-center justify-center shrink-0">
              <MessageCircle size={20} strokeWidth={2} />
            </div>
            <div className="min-w-0">
              <h2 className="font-bold text-xl text-black dark:text-white truncate">Message about this listing</h2>
              <p className="text-xs text-gray-400 dark:text-gray-500 font-semibold truncate">{kindLabel}</p>
            </div>
          </div>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4 min-h-0">
          <div className="rounded-3xl border border-gray-100 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-sm overflow-hidden">
            <div className="aspect-[4/3] bg-gray-100 dark:bg-zinc-800 relative">
              {listing.image_url ? (
                ...
                <div className="absolute inset-0 flex items-center justify-center text-gray-300 dark:text-gray-600 text-sm font-semibold">No image</div>
              )}
            ...
            <div className="p-4 border-t border-gray-100 dark:border-zinc-800">
              <p className="font-extrabold text-black dark:text-white text-base leading-snug">{listing.title}</p>
              <p className="text-sm font-extrabold text-black dark:text-white mt-2">KSH {listing.amount_per_person.toLocaleString("en-KE")}</p>
            </div>
          </div>
        ...
        <div className="shrink-0 border-t border-gray-100 dark:border-zinc-800 px-6 py-4 space-y-3 bg-white dark:bg-zinc-900">
          ...
          <button
            ...
            className={`w-full py-4 rounded-full font-bold text-lg transition-all tap-scale ${
              !sending ? "bg-black dark:bg-white text-white dark:text-black active:scale-[0.98]" : "bg-gray-100 dark:bg-zinc-800 text-gray-400 dark:text-gray-500 cursor-not-allowed"
            }`}
          >
